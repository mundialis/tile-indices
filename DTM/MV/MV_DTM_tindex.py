############################################################################
#
# MODULE:      MV_DTM_tindex
# AUTHOR(S):   Kim Kaiser
# PURPOSE:     Creates a tile index of Mecklenburg-Vorpommern DTM files
...
URL = (
    ...
    "dgm_atom?type=dataset&id=ca268792-s2q1-4a39-b34c-9ec5bf9a4469"
)
EPSG_CODE = 25833
TILE_SIZE = 2000
OUTPUT_FILE = []
...
def create_tindex_by_filename(data_list):
    ...
    tindex_gpkg = "mv_dtm_tindex_proj.gpkg"
...
data_list = [
    ...
    if "gtiff" in link.attrib.get("href", "")
]
