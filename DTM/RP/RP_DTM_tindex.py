############################################################################
#
# MODULE:      RP_DTM_tindex
# AUTHOR(S):   Kim Kaiser
# PURPOSE:     Creates a tile index of Rheinland-Pfalz DTM files
...
# Parameter for RP tif files
URL = ("https://geobasis-rlp.de/data/dgm1/current/meta4/dgm1_tif_07.meta4")
EPSG_CODE = 25832
TILE_SIZE = 1000
OUTPUT_FILE = []
os.chdir("DTM/RP/")
...
def create_tindex_by_filename(data_list):
    ...
    tindex_gpkg = "rp_dtm_tindex_proj.gpkg"
    stream = os.popen(f"ogr2ogr {tindex_gpkg} tindex.geojson")
    stream.read()
    return tindex_gpkg

# get xml from URL
tmp_xml = "/tmp/rp_dtm_tindex.xml"
