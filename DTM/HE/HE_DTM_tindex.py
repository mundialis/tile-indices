############################################################################
#
# MODULE:       HE_DTM_tindex.py
# AUTHOR(S):    Anika Weinmann
# PURPOSE:      Create tile index of Hessen DTM (German DGM) files from
...
DTM_HE_PATH="/src/tile-indices/DTM/HE/"
DTM_HE_PATH="DTM/HE/"  # locally
        ...
        for gem_var in gem_vars:
            urls.extend(
                [
                    ...
                    requote_uri(f"{BASE_URL}/{type_var} {krs}/{type_var} {gem_var} - DGM1.zip"),
                    requote_uri(f"{BASE_URL}/{type_var} {krs.split(' ')[0]}/{type_var} {gem_var} - DGM1.zip"),
