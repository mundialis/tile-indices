############################################################################
#
# MODULE:      MV_DOP_tindex
# AUTHOR(S):   Kim Kaiser, Leon Louwarts
# PURPOSE:     Creates a tile index of Mecklenburg-Vorpommern DOP files
...
URL = (
    ...
    "dop20_atom?type=dataset&id=f94d17fa-b29b-41f7-a4b8-6e10f1aae38e"
)
EPSG_CODE = 25833
TILE_SIZE = 2000
os.chdir("DOP/MV/")
...
def create_tindex_by_filename(data_list):
    ...
    tindex_gpkg = "mv_dop_tindex_proj.gpkg"
...
data_list = [
    ...
    if link.attrib.get("href", "").lower().endswith(".tif")
]
