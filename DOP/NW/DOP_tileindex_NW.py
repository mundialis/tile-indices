############################################################################
#
# MODULE:      DOP_tileindex_NW
# AUTHOR(S):   Johannes Halbauer
#
# PURPOSE:     Creats a DOP tile index for Nordrhein-Westfalen based on the file names of DOPs from https://www.opengeodata.nrw.de/produkte/geobasis/lusat/akt/dop/dop_jp2_f10/ stored in a .csv file.
...
for record in URLs:
    ...
    east_sw = int(record[98:101]) * 1000
    north_sw = int(record[102:106]) * 1000
...
gdf.to_file(geopackage, layer="openNRW_DOP10_tileindex", driver="GPKG")
